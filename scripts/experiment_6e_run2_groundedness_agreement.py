...
CHART_PATH = Path("docs/images/6e-run2-groundedness-agreement.png")  # output moved to docs/experiments/charts/6e-run2-groundedness-agreement.png (Day 7 gallery split)
